...
Validates project_id scope (same rule as file uploads) before constructing the service.
"""
...
def get_multipart_service(
    ...
    """Construct a MultipartUploadService, enforcing project-scoped token restrictions."""
