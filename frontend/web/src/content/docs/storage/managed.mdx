...
description: "FileNest managed storage â€” zero-config S3 with encryption always on."
---
...
- **Automatic lifecycle** â€” storage removed when the project is deleted
...
- The bucket is not directly accessible â€” all access goes through FileNest presigned URLs.
