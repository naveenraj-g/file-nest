...
| Tab | Description |
|-----|-------------|
| **Files** | [File explorer](/docs/console/files) — browse, upload, and manage files |
| **API Keys** | [Project-scoped API keys](/docs/console/api-keys) — create and revoke keys |
| **Webhooks** | [Webhook endpoints](/docs/console/webhooks) — subscribe to file events |
