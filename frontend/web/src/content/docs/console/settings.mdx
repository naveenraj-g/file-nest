...
description: "Configure name, storage, uploads, processing, and security for a FileNest project."
---
...
| Field | Description |
|-------|-------------|
| **Project name** | Display name shown in the Console and returned by the API |
