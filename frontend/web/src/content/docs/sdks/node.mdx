...
The `@filenest/node` SDK provides a typed client for all FileNest REST API operations. Use it in any Node.js runtime â€” Next.js server components, Express, Fastify, serverless functions, scripts.
